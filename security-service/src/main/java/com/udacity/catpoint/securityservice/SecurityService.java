...
public class SecurityService {
    ...
    public void setArmingStatus(ArmingStatus armingStatus) {
        ...
        // FIX FOR REQUIREMENT 10: Reset all sensors to inactive when armed
    ...
    private void handleSensorDeactivated() {
        switch(securityRepository.getAlarmStatus()) {
            ...
            // FIX FOR REQUIREMENT 4: Removed the ALARM -> PENDING_ALARM transition
            // When alarm is active, sensor changes should NOT affect alarm state
        }
    }
    ...
    public void changeSensorActivationStatus(Sensor sensor, Boolean active) {
        // FIX FOR REQUIREMENT 4: Don't change alarm state if already in ALARM status
